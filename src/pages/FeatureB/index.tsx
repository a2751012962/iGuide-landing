...
export default function FeatureB() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 font-sans text-slate-800">
            <Seo title={t.seo.title} description={t.seo.description} path="/featureB" lang={lang} />
            {/* Navigation */}
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="hidden md:flex items-center gap-8">
                            ...
                            <Link to="/featureB" className="text-sm font-medium text-[#E84A27] transition-colors">{t.nav.featureB}</Link>
                        </div>
